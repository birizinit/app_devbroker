  ...
  return (
    <div className="min-h-screen bg-background animate-in fade-in-0 duration-1000">
              ...
              {walletLoading ? (
                ...
                <>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {walletData.length > 0 ? "Conta Real conectada" : "Dados atualizados"}
                  </p>
                </>
              )}
            </div>
        ...
        <Card className="bg-card/90 border-border/60 overflow-hidden hover:border-primary/40 transition-all duration-300 shadow-lg">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-6 p-3 sm:p-4 rounded-lg bg-muted/60 border border-border/40">
              ...
              <div className="text-center p-2">
                <p className={`text-xs font-medium mb-1 ${botStats.profit >= 0 ? "text-purple-500" : "text-red-500"}`}>
            ...
            <div ref={tradingSectionRef} className="mb-6">
              ...
              <div className="h-[800px] rounded-lg overflow-hidden border border-border/40">
                <iframe
                  src="https://app.cowbex.com/auth/login"
                  title="Cowbex Trading Platform"
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  {(activeTrades.length === 0 && completedTrades.length === 0) ? (
                    ...
                    <>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <Badge variant="outline" className={`text-xs ${trade.status === "WIN" ? "bg-purple-500/20 text-purple-500 border-purple-500/50" : "bg-red-500/20 text-red-500 border-red-500/50"}`}>
                        ...
                        <div className="text-right">
                          <p
                            className={`text-xs font-medium ${
                              trade.result && trade.result > 0 ? "text-purple-500" : "text-red-500"
                            }`}
                          >
      ...
      <AlertDialog open={showWelcomeDialog} onOpenChange={setShowWelcomeDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Bem-vindo ao Dev Brokers!</AlertDialogTitle>
            <AlertDialogDescription>

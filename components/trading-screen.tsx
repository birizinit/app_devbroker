              ...
              <CardContent>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p
                      className={`text-sm flex items-center gap-1 ${priceChange >= 0 ? "text-purple-400" : "text-red-400"}`}
                    >
            ...
            <Card className="bg-gradient-to-r from-gray-900/50 to-black/50 border-gold-500/20 backdrop-blur-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-gold-400">
                  ...
                  <Badge className={isDemoMode ? "bg-blue-500/20 text-blue-400" : "bg-purple-500/20 text-purple-400"}>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg border border-gray-700/50">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full ${botActive ? "bg-purple-400 animate-pulse" : "bg-red-400"}`}
                    />
                    <div>
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    <p className={`text-2xl font-bold ${botStats.winRate >= 50 ? "text-purple-400" : "text-red-400"}`}>
                      {botStats.winRate.toFixed(1)}%
                    </p>
                    <p className="text-sm text-gray-400">Taxa de Acerto</p>
                  </div>
                  <div className="text-center">
                    <p className={`text-2xl font-bold ${botStats.profit >= 0 ? "text-purple-400" : "text-red-400"}`}>
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge
                              className={
                                trade.isDemo ? "bg-blue-500/20 text-blue-400" : "bg-purple-500/20 text-purple-400"
                              }
                            >
                          ...
                          <span
                            className={`text-sm font-medium ${
                              trade.direction === "BUY" ? "text-purple-400" : "text-red-400"
                            }`}
                          >
                            {trade.direction}
                          </span>
                      ...
                      >
                        ...
                        {trade.pnl !== undefined && (
                          <div className="flex justify-between items-center text-sm mt-1">
                            ...
                            <span className={`font-medium ${trade.pnl >= 0 ? "text-purple-400" : "text-red-400"}`}>
                              ${trade.pnl.toFixed(2)}
                            </span>
                          </div>
                        )}
